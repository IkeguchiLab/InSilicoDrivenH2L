...
for i2 in {1..80};do
    ...
    gmx grompp -f ${MDP_PATH}transitions_from_npt_l0.mdp -c frame\${i2}_${ligA}_merged.gro -r frame\${i2}_${ligA}_merged.gro -p topol.top -o ../ti\${i2}.tpr -po ../mdout_\${i2}.mdp -maxwarn 7
done
rm \#*
rm ../\#*
fi
...
for i2 in {1..80};do
    ...
    gmx grompp -f ${MDP_PATH}transitions_from_npt_l0.mdp -c frame\${i2}_${ligB}_merged.gro -r frame\${i2}_${ligB}_merged.gro -p topol.top -o ../ti\${i2}.tpr -po ../mdout_\${i2}.mdp -maxwarn 7
done
rm \#*
rm ../\#*
fi
