...
df = pd.read_csv('results_summary_core4_Mpocket_cycle_exclude18to23.csv')
...
df_output.to_csv("final_results_core4_Mpocket_cycle_exclude18to23.tsv", sep='\t', index=False)
